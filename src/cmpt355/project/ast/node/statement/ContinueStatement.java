...
public class ContinueStatement extends Statement {
    ...
    public void generateCode(CompileContext context) {
        ...
        Loop loop = maybeLoop.orElseThrow(() -> new RuntimeException(new SyntaxException("Continue statement not inside loop!")));
        context.addCode(Instruction.new_goto(loop.getContinueLabel()));
    }
}
